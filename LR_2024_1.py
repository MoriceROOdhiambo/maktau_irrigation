...
maizePH1=Crop('Maize', planting_date='04/03', PlantMethod=1, CalenderType=1, CGC=0.163, CDC=0.117,
               ...
               Zmin=0.3, Zmax=1.0, PlantPop=plant_population, WP=33.7, CCx=0.88,                
...
irr_mngt = IrrigationManagement(irrigation_method=2,WetSurf=wetted_surface,AppEff=90,MaxIrr=irr_depth,IrrInterval=3)
